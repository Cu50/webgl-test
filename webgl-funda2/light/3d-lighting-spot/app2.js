...
function main() {
    ...
    var vertexShaderSource = getSourceSynch("vertexShaderSource.vs");
    var fragmentShaderSource = getSourceSynch("fragmentShaderSource.fs");
    ...
    var limitLocation = gl.getUniformLocation(program, "u_innerLimit");
    var innerLimitLocation = gl.getUniformLocation(program, "u_outerLimit");
    var outerLimitLocation = gl.getUniformLocation(program, "u_limit");
    ...
    webglLessonsUI.setupSlider("#lightx", {
    ...
    webglLessonsUI.setupSlider("#lighty", {
    ...
    function updateInnerLimit() {
        return function (event, ui) {
            var angleInDegrees = ui.value;
            var angleInRadians = degToRad(angleInDegrees);
            innerLimit = angleInRadians;
            drawScene();
        };
    }
    function updateOuterLimit() {
        return function (event, ui) {
            var angleInDegrees = ui.value;
            var angleInRadians = degToRad(angleInDegrees);
            outerLimit = angleInRadians;
            drawScene();
        };
    }
    // Draw the scene.
